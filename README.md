...
GitHub Actions 每天 09:00（北京时间）读取 Simpanda 的公开库存接口，并同步更新 Giffgaff 电话卡与 10 英镑充值券库存。首次配置仅需在仓库 Actions Secrets 中设置 `SUPABASE_SERVICE_ROLE_KEY`；库存接口不需要 Simpanda 登录信息。
