...
本项目是一个面向**中国国内用户**的实用指南合集，帮助希望拓展全球生活、工作、投资能力的数字游民群体，系统性地解决跨境金融基础设施问题。

核心覆盖三大模块：

| 模块 | 说明 | 状态 |
|------|------|------|
| 💳 [银行卡](./docs/bank-cards/) | 香港、新加坡等境外银行账户开设攻略 | 🟢 持续更新 |
| 📱 [电话卡](./docs/phone-cards/) | 海外实体/eSIM卡购买、激活与保号教程 | 🟢 持续更新 |
| 📈 [证券账户](./docs/securities/) | 美股/港股/全球券商开户与使用指南 | 🟢 持续更新 |
...
1. 本指南内容仅供学习交流，不构成任何投资或法律建议。
2. 开户与投资有风险，请自行评估并承担相应风险。
3. 各金融机构政策随时可能调整，请以官方最新信息为准。
4. 跨境金融活动需遵守中国相关法律法规（如外汇管理规定等）。
