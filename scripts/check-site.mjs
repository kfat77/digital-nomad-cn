...
if (tools.length !== 23 || externalLinks.length < 23 || !homepage.includes('id="ai-subscriptions"')) {
  throw new Error('Tool directory must contain 23 externally linked cards including AI subscriptions');
}
